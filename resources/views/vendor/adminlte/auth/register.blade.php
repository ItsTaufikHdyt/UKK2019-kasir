    ...
    <div id="app">
        <div class="register-box">
            <div class="register-logo">
                <a href="{{ url('user/store2') }}"><b>Admin</b>LTE</a>
            </div>
            ...
            <div class="register-box-body">
                ...
                <form action="{{ url('user/store2') }}" method="post">
                    ...
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" placeholder="{{ trans('adminlte_lang::message.fullname') }}" name="nama_user" value="{{ old('nama_user') }}"/>
