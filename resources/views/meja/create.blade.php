...
<div class="container-fluid spark-screen">
    <div class="box box-info">
        ...
        <div class="box box-body">
            <form action="{{url('meja/store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            <input type="number" class="form-control" name="no_meja"  placeholder="Otomatis">
